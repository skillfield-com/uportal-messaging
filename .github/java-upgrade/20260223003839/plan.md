...
- **Working branch**: appmod/java-upgrade-20260223003839

- **Java version**: 8

## Development Environment
- **Source JDK path (Java 8)**: /Users/subodhchettri/.jdk/jdk-8/Contents/Home/bin
- **Target JDK path (Java 21)**: /opt/homebrew/Cellar/openjdk@21/21.0.10/libexec/openjdk.jdk/Contents/Home/bin
...
- Upgrade Spring Boot to 2.7.x <!-- org.springframework.boot:*:2.7.x -->
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260223003839`.
...
3. Achieve the objectives set for each milestone one by one until the final upgrade goal is reached. At this stage, focus only on upgrading the required dependencies and Java version to meet the upgrade targets and ensuring the project can be built.
    - Milestone 1: Upgrade project to use `Spring Boot 2.7.x`, `Java 21`
